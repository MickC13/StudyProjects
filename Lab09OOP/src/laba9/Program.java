...
public class Program {
    ...
    // Объявляем компоненты как поля класса для доступа из слушателей
	  JTextField clientNameField;    // было private
	  JTextField phoneField;         // было private
	  JTextField addressField;       // было private
	  JTextField newspaperField;
     ...
     */
     void updateSurnameComboBox(DefaultTableModel model, JComboBox<String> comboBox) {
